...
function displayWeather(data) {
  ...
  // Display weather image first, then climate information
  weatherDetails.innerHTML = `
      <img src="http://openweathermap.org/img/wn/${icon}@4x.png" alt="Weather Icon" class="weather-icon">
...
function displayWeather(data) {
  ...
  // Display weather image and climate info side by side
  weatherDetails.innerHTML = `
